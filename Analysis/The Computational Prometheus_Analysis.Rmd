---
title: "The Computational Prometheus"
subtitle: "Tracing the Evolution of Sci-Fi through Structural Topic Modeling"
author: "Liam Yardley"
...
# --- Topic Colour coding ---
# Romance (Red)
romance_topics = c(31,28,2,18,23,33,9,12,24,3,24,27,14,23,13,17,10,3,8) 
# Gothic (Purple)
gothic_topics = c(28,27,8,9,12,23,18,7,34,31,24,16,3,34)
# Sci-Fi (Blue)
scifi_topics = c(7,25,4,18,22,11,23,8,28,9,21,32,26,12,14,34)
# Shelley (Yellow)
shelley_topics = c(9,20,33,31,3,10,19,34,17,8,21)
...
[Mitra, 2011] Mitra, Z. (2011). A science fiction in a gothic scaffold: A reading of mary shelley’s Frankenstein. Rupkatha
Journal on Interdisciplinary Studies in Humanities, 3(1):52–59.

[Paley, 1993] Paley, M. D. (1993). Mary shelley’s The Last Man: Apocalypse without millennium. Keats-Shelley Review,
4(1):1–25.
...
The AI assisted in refining the "Problem Statement" and "Abstract" to ensure conciseness and clarity.
 ...
 Note: The core literary arguments, the interpretation of the "Bridge" hypothesis, and the final conclusions regarding Shelley’s
